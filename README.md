...
- Migration và Model cho `sv23810310136_categories` và `sv23810310136_products`
- Chi tiết xem tại:  
  [database/migrations]
...
- Đổi từ amber sang mã `#E91E63` trong `AdminPanelProvider.php`  
...
- Xem code: [app/Filament/Resources/CategoryResource.php]
...
- Xem code: [app/Filament/Resources/ProductResource.php]
